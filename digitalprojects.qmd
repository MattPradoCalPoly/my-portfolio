...
Analyzed website engagement and acquisition performance for Trauma Resource Institute using Google Analytics, Google Tag Manager, and Square Space data.
...
<iframe src="../pdfs/IBM6010_Final_Presentation.pdf" width="100%" height="600px" style="border: none; border-radius: 8px;">

</iframe>

<a href="../pdfs/IBM6010_Final_Presentation.pdf" target="_blank"> 📄 Open Presentation in New Tab </a>
...
<iframe src="../pdfs/IBM6100_Final_Presentation.pdf" width="100%" height="600px" style="border: none; border-radius: 8px;">

</iframe>

<a href="../pdfs/IBM6100_Final_Presentation.pdf" target="_blank"> 📄 Open Presentation in New Tab </a>